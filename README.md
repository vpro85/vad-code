...
- **25+ инструментов для работы с файлами**: `list_files`, `read_file`, `write_file`, `search_in_files`, `run_command` и др.
...
### Кратко о реализованном (v0.3.0)
- Мульти-провайдерная архитектура (OpenAI, Ollama, Anthropic, LM Studio)
- 25+ инструментов для работы с файлами
